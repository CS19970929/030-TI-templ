...
//IO��������
#define SDA_IN()  {GPIOF->MODER&=0xFFFF3FFF;GPIOF->MODER|=(UINT32)0<<14;}		//Ĭ��ֵΪ00���Ȳ�����Ҳ���������롣
#define SDA_OUT() {GPIOF->MODER&=0xFFFF3FFF;GPIOF->MODER|=(UINT32)1<<14;}		//����������ͺ�����ٶȣ���Ĭ��ֵ��Init������ã�����������Ч

//IO��������	 
#define IIC_SCL    PORT_OUT_GPIOF->bit6 	//SCL
#define IIC_SDA    PORT_OUT_GPIOF->bit7		//SDA
#define READ_SDA   (uint16_t)(GPIOF->IDR&GPIO_Pin_7)  //����SDA 
