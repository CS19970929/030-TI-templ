...
//磷酸铁锂
#elif (defined(LIFEPO))
#define E2P_PROTECT_DEFAULT_PRT	{/*单节过压*/3550,	3550,	3750,	3550,	300,\
								 /*单节低压*/2700,	2700,	2300,	2450,	300,\
								 /*总压过压*/365*SNum, 365*SNum,	375*SNum, 360*SNum, 100,\
								 /*总压低压*/250*SNum, 250*SNum,	250*SNum, 260*SNum, 100,\
		        				 /*充电过流*/1300,	1300,	1300,	500,	100,\
		        				 /*放电过流*/1400,	1500,	1600,	1000,	100,\
								 /*充电高温*/900,	900,	950,	900,	100,\
								 /*充电低温*/450,	430,	120,	430,	100,\
								 /*放电高温*/900,	900,	1000,	950,	100,\
								 /*放电低温*/300,	300,	200,	300,	100,\
		        				 /*驱动高温*/1000,	1100,	1250,	1200,	100,\
		        				 /*压差过大*/1000,	1000,	1000,	900,	100,\
		        				 /*电量过低*/3,		2,		1,		2,		100}
#endif
